...
INSERT INTO Answer (text, ques_id, explanation, correct, param_id) VALUES
  ...
  ('Incorrect Ans 3', 1, 'Short explanation 3', TRUE, NULL),
  ('Incorrect Ans 4', 1, 'Short explanation 4', TRUE, NULL),
  ('Incorrect Ans 5', 1, 'Short explanation 5', TRUE, NULL),
  ('Incorrect Ans 6', 1, 'Short explanation 6', TRUE, NULL),
  ('Correct Ans 1',   2, '', TRUE, NULL),
  ('Correct Ans 2',   2, '', TRUE, NULL),
  ('Incorrect Ans 3', 2, 'Short explanation 3', TRUE, NULL),
  ('Incorrect Ans 4', 2, 'Short explanation 4', TRUE, NULL),
  ('Incorrect Ans 5', 2, 'Short explanation 5', TRUE, NULL),
  ('Incorrect Ans 6', 2, 'Short explanation 6', TRUE, NULL),
  ('Correct Ans 1v1',   2, '', TRUE, 1),
  ('Correct Ans 2v1',   2, '', TRUE, 1),
  ('Correct Ans 3v1',   2, '', TRUE, 1),
  ('Incorrect Ans 4v1', 2, 'Short explanation 4', TRUE, 1),
  ('Incorrect Ans 5v1', 2, 'Short explanation 5', TRUE, 1),
  ('Incorrect Ans 6v1', 2, 'Short explanation 6', TRUE, 1),
  ('Incorrect Ans 7v1', 2, 'Short explanation 7', TRUE, 1),
  ('Incorrect Ans 8v1', 2, 'Short explanation 8', TRUE, 1),
  ('Correct Ans 1v2',   2, '', TRUE, 1),
  ('Correct Ans 2v2',   2, '', TRUE, 1),
  ('Correct Ans 3v2',   2, '', TRUE, 1),
  ('Incorrect Ans 4v2', 2, 'Short explanation 4', TRUE, 2),
  ('Incorrect Ans 5v2', 2, 'Short explanation 5', TRUE, 2),
  ('Incorrect Ans 6v2', 2, 'Short explanation 6', TRUE, 2),
  ('Incorrect Ans 7v2', 2, 'Short explanation 7', TRUE, 2),
  ('Incorrect Ans 8v2', 2, 'Short explanation 8', TRUE, 2);